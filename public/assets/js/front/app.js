...
createApp({
    setup() {
        ...
        const loyaltyState = ref({ registered: false, authRequired: false, active: false , customer: {}, program: {} });
        const loyaltyACtive = ref(false); // Activacion del boton de Loyalty
        ...
        const fetchData = async () => {
            ...
            try {
                ...
                // Validamos si el negocio cuenta con programa de lealtad activo
                checkLoyaltyStatus();
            ...
            } catch (e) { businessError.value = true;}//<-- Aca si mostramos el error en frontend }
        ...
        const checkLoyaltyStatus = async () => {
            try {
                ...
                if (res.ok) {
                    ...
                    loyaltyACtive.value = data.program.active;
        ...
        return {
            ...
            cart, showCartModal, customerName, customerPhone, decreaseCartItem, cartTotalItems, cartTotalPrice, checkout,
            showLoyaltyModal, loyaltyForm, loyaltyState, isRecovering,
            openLoyaltyModal, loyaltyACtive, registerLoyalty, loginLoyalty, logoutLoyalty, toggleRecoverMode, resetLoyaltyState
        };
    }
}).mount('#app');